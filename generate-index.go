...
@media (max-width: 768px) {
  ...
  .footer-grid { flex-direction: column; gap: 24px; margin-bottom: 24px; }
}
  </style>
</head>
<body>
    ...
    <div class="container">
      <div class="footer-grid">
        <div class="footer-col">
          <h4>Supermodel Tools</h4>
          <a href="/mcp/">mcp</a>
          <a href="/typescript-sdk/">typescript-sdk</a>
          <a href="/graph2md/">graph2md</a>
          <a href="/dead-code-hunter/">dead-code-hunter</a>
          <a href="/mcpbr/">mcpbr</a>
          <a href="/openapi-spec/">openapi-spec</a>
          <a href="/software-agent-sdk/">software-agent-sdk</a>
          <a href="/supermodel-api-docs/">supermodel-api-docs</a>
        </div>
        <div class="footer-col">
          <h4>Connect</h4>
          <a href="https://supermodeltools.com">supermodeltools.com</a>
          <a href="https://github.com/supermodeltools">GitHub @supermodeltools</a>
          <a href="https://x.com/supermodeltools">X @supermodeltools</a>
        </div>
      </div>
      <p class="footer-credit">Generated with <a href="https://github.com/supermodeltools/arch-docs">arch-docs</a></p>
    </div>
  </footer>
